...
are \texttt{-a} and \texttt{-l} and \texttt{Pfalciparum} is the
argument:

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
ls\PY{+w}{ }\PYZhy{}al\PY{+w}{ }Pfalciparum/
\end{Verbatim}
\end{tcolorbox}

    The argument instructs the \texttt{ls} command to display the content of
the specified directory, in this case \texttt{Pfalciparum} instead of
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
find\PY{+w}{ }.\PY{+w}{ }\PYZhy{}name\PY{+w}{ }\PY{l+s+s2}{\PYZdq{}Malaria.fa\PYZdq{}}
\end{Verbatim}
\end{tcolorbox}
